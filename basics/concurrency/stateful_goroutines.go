...
and channels to achieve the same result. This channel-based approach aligns
...
In order to read or write that state, other goroutines will send messages to the
owning goroutine and receive corresponding replies. These readOp and writeOp structs
...
func StatefullGoRoutines() {
	...
	// when managing multiple such mutexes would be error-prone. You should use whichever approach feels
	// most natural, especially with respect to understanding the correctness of your program.
}
