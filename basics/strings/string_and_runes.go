...
A Go string is a read-only slice of bytes. The language and the standard library treat
strings specially - as containers of text encoded in UTF-8. In other languages, strings
are made of "characters". In Go, the concept of a character is called a rune -
...
func StringAndRunes() {
	...
	// because it has to decode each UTF-8 rune sequentially. Some Thai characters are represented
	// by multiple UTF-8 code points, so the result of this count may be surprising.
